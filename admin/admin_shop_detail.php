...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="shop-body">
        ...
        <div class="container row row-cols-6 row-cols-md-12 g-5 mb-4" id="shop-header">
            ...
            <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="admin_food_detail.php?s_id=<?php echo $row["s_id"]?>"
                                class="btn btn-sm btn-primary">View</a>
                            <a href="admin_food_edit.php?s_id=<?php echo $row["s_id"]?>"
                                class="btn btn-sm btn-outline-success">Edit</a>
                            <a href="admin_food_delete.php?s_id=<?php echo $row["s_id"]?>"
